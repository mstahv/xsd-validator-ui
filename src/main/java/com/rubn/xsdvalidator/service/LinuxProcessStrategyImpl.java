 ...
 * @author rubn
 */
public class LinuxProcessStrategyImpl implements Predicate<String[]> {

    @Override
    public boolean test(String... command) {
        return this.detectTheJavaProcessByName(line -> line.contains(XsdValidatorConstants.XSD_VALIDATOR_UI_JAR), command);
    }
