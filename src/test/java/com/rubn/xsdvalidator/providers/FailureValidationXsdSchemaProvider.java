...
public class FailureValidationXsdSchemaProvider implements ArgumentsProvider {

    private static final Path XML_ORDER_INSTANCE_MOCK_PATH = Path.of("src/test/resources/documents/validation-failure/order-instance.xml");
