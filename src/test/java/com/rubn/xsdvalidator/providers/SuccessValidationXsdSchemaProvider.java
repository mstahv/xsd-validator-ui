...
public class SuccessValidationXsdSchemaProvider implements ArgumentsProvider {

    private static final Path XML_ORDER_INSTANCE_MOCK_PATH = Path.of("src/test/resources/documents/validation-successfully/order-instance.xml");
    private static final Path XSD_MAIN_ORDER_MOCK_PATH = Path.of("src/test/resources/documents/validation-successfully/main-order.xsd");
    private static final Path XSD_DATATYPES_MOCK_PATH = Path.of("src/test/resources/documents/validation-successfully/datatypes.xsd");
    private static final Path XSD_PRODUCT_MOCK_PATH = Path.of("src/test/resources/documents/validation-successfully/product.xsd");
    ...
    public Stream<? extends Arguments> provideArguments(ParameterDeclarations parameters, ExtensionContext context) throws Exception {
        ...
        return Stream.of(Arguments.of(array1, array2, mapPrefixFileNameAndContent));
    }
}
